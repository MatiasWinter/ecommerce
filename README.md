# Ecommerce - API Principal

Este proyecto corresponde al **módulo principal del sistema de Ecommerce**, está desarrollado con **Spring Boot 3.x.x** y **Java 21**.  
Se encarga de la gestión de **clientes** y **productos**, y además de realizar los procesos de **venta** y **confirmación de pago** comunicándose con el microservicio "ecommerce-venta"
...
- **ecommerce:** gestiona clientes, productos y procesos de venta.
- **ecommerce-venta:** gestiona ventas, detalles y pagos.
